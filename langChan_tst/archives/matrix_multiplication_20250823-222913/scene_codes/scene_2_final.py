...
# Layout: split_screen
# Generated at: 2025-08-23 22:34:38
...
Scene2.narration_text = """Before we multiply, we must check if the matrices are compatible. For matrix A multiplied by matrix B, the number of columns in A must precisely equal the number of rows in B. The resulting product matrix will then have the number of rows from A and the number of columns from B."""
Scene2.audio_duration = 22.250958
