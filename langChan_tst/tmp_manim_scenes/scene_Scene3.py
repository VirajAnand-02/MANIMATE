...
"""
        ...
        sub_node1 = Rectangle(width=1.5, height=0.5, color=PURPLE, fill_opacity=0.6).next_to(main_node, LEFT, buff=0.5)
        sub_node2 = Rectangle(width=1.5, height=0.5, color=PURPLE, fill_opacity=0.6).next_to(main_node, RIGHT, buff=0.5)
